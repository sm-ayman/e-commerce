...
const Footer = () => {
  return (
    <footer className="px-4 divide-y dark:bg-[#233142] dark:text-gray-100">
      ...
      <div className="py-6 text-sm text-center dark:text-gray-400">
          ...
          <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
            <div class="relative w-full">
              ...
              <input
                ...
                placeholder="Get exclusive offers on your email (Enter Email)"
                type="email"
                id="email"
                required=""
              />
        ...
        © 2023 Goods Era. All rights reserved.
      </div>
    </footer>
  );
};
