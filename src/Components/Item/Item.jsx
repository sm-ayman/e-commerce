...
const Item = (props) => {
  return (
    <div className="py-6 flex justify-center">
      <div className="card w-64 glass shadow-lg transition-transform transform hover:scale-105">
        <figure>
          <img className="w-60 h-full object-cover rounded-t-md" src={props.image} alt="" />
        </figure>
        <div className="card-body p-2">
          ...
          <div className="flex justify-between mt-4">
            ...
            <div className="text-purple-600 font-semibold">৳{props.new_price}</div>
          </div>
